...
import { getEntities, updateEntity, deleteEntity, createEntity  } from './nse.reducer';
...
export const NSE = (props: INSEProps) => {
  ...
  const isEditing = (record: INSE) => record.id === editingId;
  ...
  const save = async (id: React.Key) => {
    try {
      const row = (await form.validateFields()) as INSE;
...
const mapStateToProps = ({ nSE }: IRootState) => ({
  entityList: nSE.entities,
  loading: nSE.loading,
  updating: nSE.updating,
