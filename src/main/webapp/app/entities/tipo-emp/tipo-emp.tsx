...
import { getEntities, updateEntity, deleteEntity, createEntity } from './tipo-emp.reducer';
...
export const TipoDesp = (props: ITipoDespProps) => {
  ...
  const isEditing = (record: ITipoEmp) => record.id === editingId;
  ...
  const save = async (id: React.Key) => {
    try {
      const row = (await form.validateFields()) as ITipoEmp;
...
const mapStateToProps = ({ tipoEmp }: IRootState) => ({
  entityList: tipoEmp.entities,
  loading: tipoEmp.loading,
  updating: tipoEmp.updating,
