...
export const TipoObra = (props: ITipoObraProps) => {
  ...
  const { tipoObraList, match, loading, totalItems } = props;
  return (
    <div>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${tipoObra.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${tipoObra.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
      ...
      {props.totalItems ? (
        <div className={tipoObraList && tipoObraList.length > 0 ? '' : 'd-none'}>
...
const mapStateToProps = ({ tipoObra }: IRootState) => ({
  ...
  totalItems: tipoObra.totalItems,
});
