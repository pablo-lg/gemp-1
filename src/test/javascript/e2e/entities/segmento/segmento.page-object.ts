...
export class SegmentoDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('gempApp.segmento.delete.question'));
...
export default class SegmentoComponentsPage {
  ...
  async deleteSegmento() {
    ...
    expect(await segmentoDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gempApp.segmento.delete.question/);
